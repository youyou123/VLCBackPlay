...
public class PlayActivity extends Activity implements IVideoPlayer {
	public final static String TAG = "samoondv/PlayerActivity";
	...
	private static final int PHOTO_INFO = 5;
	private static final int NORMAL_INFO = 6;
	private static final int EVENT_INFO = 7;
...
//	private AutoHorizontalScrollViewAdapter adapter;
	// Brightness
	...
	private ArrayList<String> datasView = new ArrayList<String>();
	private GridView dataGrids;
	//private AutoHorizontalScrollerView horview;
	//private AutoHorizontalScrollerView horviewEvent;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mSurface = (SurfaceView) findViewById(R.id.player_surfaceone);

		mSurfaceHolder = mSurface.getHolder();
		mSurfaceFrame = (FrameLayout) findViewById(R.id.player_surface_frameone);
		...
		// String s1= "http://192.168.42.1/NORMAL/S_video/";
		// String s = "rtsp://192.168.42.1/live";
	...
	public static void start(Context context, String location, String title,
		...
		intent.setAction(PlayActivity.PLAY_FROM_VIDEOGRID);
	...
	private static class VideoPlayerEventHandler extends
			WeakHandler<PlayActivity> {
		public VideoPlayerEventHandler(PlayActivity owner) {
			super(owner);
		}
	...
	// 数据切换
	private Handler InfoHandlers = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case PHOTO_INFO:
				...
				break;
			case NORMAL_INFO:
				String normal = (String) msg.obj;
				mTitle.setText(normal);
				break;
			case EVENT_INFO:
	...
	private void changeSurfaceSize() {
		...
		lp.height = dh * mVideoHeight / mVideoVisibleHeight - 42;
    ...
    */
	private final OnClickListener mAudioTrackListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			dialog.setOwnerActivity(PlayActivity.this);
			dialog.show();
		}
	};
    ...
    */
	...
	private final SurfaceHolder.Callback mSurfaceCallback = new Callback() {
		...
		public void surfaceChanged(SurfaceHolder holder, int format, int width,
			...
			mLibVLC.attachSurface(holder.getSurface(), PlayActivity.this,
					width, height);
		}
	...
	private void updateOverlayPausePlay() {
		...
		mPlayPause.setBackgroundResource(mLibVLC.isPlaying() ? 0
				: R.drawable.ic_play);
	}
	...
	private void load() {
		...
		if (mLocation != null && mLocation.length() > 0 && !dontParse) {
			...
			if (media != null) {
				...
				// long rTime =
				// preferences.getLong(PreferencesActivity.VIDEO_RESUME_TIME,
				// -1);
				// SharedPreferences.Editor editor = preferences.edit();
			...
			// preferences.getString(PreferencesActivity.VIDEO_SUBTITLE_FILES,
			// null);
			ArrayList<String> prefsList = new ArrayList<String>();
			// if(subtitleList_serialized != null) {
			// ByteArrayInputStream bis = new
			// ByteArrayInputStream(subtitleList_serialized.getBytes());
			// try {
